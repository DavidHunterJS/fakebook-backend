...
var CWD = process.cwd();
console.log("[DEBUG] Current Working Directory: ".concat(CWD));
// 2. Construct the full, absolute path to the .env file we expect to find.
var envPath = path_1.default.resolve(CWD, '.env');
console.log("[DEBUG] Attempting to load .env file from: ".concat(envPath));
// --- END: DEBUG LOGGING ---
...
function createSubscriptionCheckout() {
    return __awaiter(this, void 0, void 0, function () {
        var userId, priceId, session, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    userId = '68ee9cb477be39fc754aa744';
                    priceId = 'price_1SIDvVQT7T1f70ikTKYMfXmD';
